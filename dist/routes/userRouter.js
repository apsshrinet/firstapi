...
router.post('/register', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var email, password, age, name_1, phoneno, result, a, obj, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                result = uservalidation_1.userschema.validateAsync(req.body);
                console.log("Validated the data");
                return [4 /*yield*/, (0, userregister_1.adduser)(email, password, age, name_1, phoneno)];
            case 2:
                a = _a.sent();
